...
class ProdAType
{
     ...
     * (NT 2011/004)
     *
     * @property \Evino\Gallywix\DataTransfer\Nfe\TNFeType\InfNFeAType\DetAType\ProdAType\DIAType[]
     * $dI
     */
    private $dI = array(
     ...
     *
     * @property
     * \Evino\Gallywix\DataTransfer\Nfe\TNFeType\InfNFeAType\DetAType\ProdAType\DetExportAType[]
     * $detExport
     */
    ...
    /**
     * @property
     * \Evino\Gallywix\DataTransfer\Nfe\TNFeType\InfNFeAType\DetAType\ProdAType\RastroAType[] $rastro
     */
     ...
     *
     * @property
     * \Evino\Gallywix\DataTransfer\Nfe\TNFeType\InfNFeAType\DetAType\ProdAType\VeicProdAType
     * $veicProd
     */
     ...
     *
     * @property \Evino\Gallywix\DataTransfer\Nfe\TNFeType\InfNFeAType\DetAType\ProdAType\MedAType
     * $med
     */
    private $med = null;
     ...
     * Armamentos
     *
     * @property \Evino\Gallywix\DataTransfer\Nfe\TNFeType\InfNFeAType\DetAType\ProdAType\ArmaAType[]
     * $arma
     */
    private $arma = array(
     ...
     *
     * @property \Evino\Gallywix\DataTransfer\Nfe\TNFeType\InfNFeAType\DetAType\ProdAType\CombAType
     * $comb
     */
    private $comb = null;
     ...
     *
     * @return self
     * @param \Evino\Gallywix\DataTransfer\Nfe\TNFeType\InfNFeAType\DetAType\ProdAType\DIAType $dI
     */
    public function addToDI(\Evino\Gallywix\DataTransfer\Nfe\TNFeType\InfNFeAType\DetAType\ProdAType\DIAType $dI)
    {
        $this->dI[] = $dI;
        return $this;
    }
     ...
     * (NT 2011/004)
     *
     * @return \Evino\Gallywix\DataTransfer\Nfe\TNFeType\InfNFeAType\DetAType\ProdAType\DIAType[]
     */
     ...
     *
     * @return self
     * @param \Evino\Gallywix\DataTransfer\Nfe\TNFeType\InfNFeAType\DetAType\ProdAType\DetExportAType
     * $detExport
     */
    public function addToDetExport(\Evino\Gallywix\DataTransfer\Nfe\TNFeType\InfNFeAType\DetAType\ProdAType\DetExportAType $detExport)
    {
     ...
     *
     * @return self
     * @param \Evino\Gallywix\DataTransfer\Nfe\TNFeType\InfNFeAType\DetAType\ProdAType\RastroAType
     * $rastro
     */
    public function addToRastro(\Evino\Gallywix\DataTransfer\Nfe\TNFeType\InfNFeAType\DetAType\ProdAType\RastroAType $rastro)
    {
        $this->rastro[] = $rastro;
        return $this;
    }
     ...
     * Gets as rastro
     *
     * @return \Evino\Gallywix\DataTransfer\Nfe\TNFeType\InfNFeAType\DetAType\ProdAType\RastroAType[]
     */
     ...
     * Veículos novos
     *
     * @return \Evino\Gallywix\DataTransfer\Nfe\TNFeType\InfNFeAType\DetAType\ProdAType\VeicProdAType
     */
     ...
     * Veículos novos
     *
     * @param \Evino\Gallywix\DataTransfer\Nfe\TNFeType\InfNFeAType\DetAType\ProdAType\VeicProdAType
     * $veicProd
     * @return self
     */
    public function setVeicProd(\Evino\Gallywix\DataTransfer\Nfe\TNFeType\InfNFeAType\DetAType\ProdAType\VeicProdAType $veicProd)
    {
     ...
     * grupo do detalhamento de Medicamentos e de matérias-primas farmacêuticas
     *
     * @return \Evino\Gallywix\DataTransfer\Nfe\TNFeType\InfNFeAType\DetAType\ProdAType\MedAType
     */
     ...
     * grupo do detalhamento de Medicamentos e de matérias-primas farmacêuticas
     *
     * @param \Evino\Gallywix\DataTransfer\Nfe\TNFeType\InfNFeAType\DetAType\ProdAType\MedAType $med
     * @return self
     */
    public function setMed(\Evino\Gallywix\DataTransfer\Nfe\TNFeType\InfNFeAType\DetAType\ProdAType\MedAType $med)
    {
        $this->med = $med;
        return $this;
    }
     ...
     *
     * @return self
     * @param \Evino\Gallywix\DataTransfer\Nfe\TNFeType\InfNFeAType\DetAType\ProdAType\ArmaAType $arma
     */
    public function addToArma(\Evino\Gallywix\DataTransfer\Nfe\TNFeType\InfNFeAType\DetAType\ProdAType\ArmaAType $arma)
    {
        $this->arma[] = $arma;
        return $this;
    }
     ...
     * Armamentos
     *
     * @return \Evino\Gallywix\DataTransfer\Nfe\TNFeType\InfNFeAType\DetAType\ProdAType\ArmaAType[]
     */
     ...
     * Armamentos
     *
     * @param \Evino\Gallywix\DataTransfer\Nfe\TNFeType\InfNFeAType\DetAType\ProdAType\ArmaAType[]
     * $arma
     * @return self
     */
     ...
     * Informar apenas para operações com combustíveis líquidos
     *
     * @return \Evino\Gallywix\DataTransfer\Nfe\TNFeType\InfNFeAType\DetAType\ProdAType\CombAType
     */
     ...
     * Informar apenas para operações com combustíveis líquidos
     *
     * @param \Evino\Gallywix\DataTransfer\Nfe\TNFeType\InfNFeAType\DetAType\ProdAType\CombAType $comb
     * @return self
     */
    public function setComb(\Evino\Gallywix\DataTransfer\Nfe\TNFeType\InfNFeAType\DetAType\ProdAType\CombAType $comb)
    {
        $this->comb = $comb;
        return $this;
    }
