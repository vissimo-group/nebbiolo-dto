...
class DIAType
{
     ...
     *
     * @property
     * \Evino\Gallywix\DataTransfer\Nfe\TNFeType\InfNFeAType\DetAType\ProdAType\DIAType\AdiAType[]
     * $adi
     */
    private $adi = array(
     ...
     * @return self
     * @param
     * \Evino\Gallywix\DataTransfer\Nfe\TNFeType\InfNFeAType\DetAType\ProdAType\DIAType\AdiAType $adi
     */
    public function addToAdi(\Evino\Gallywix\DataTransfer\Nfe\TNFeType\InfNFeAType\DetAType\ProdAType\DIAType\AdiAType $adi)
    {
        $this->adi[] = $adi;
        return $this;
    }
