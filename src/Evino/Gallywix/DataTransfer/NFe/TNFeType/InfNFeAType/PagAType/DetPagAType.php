...
namespace Evino\Gallywix\DataTransfer\Nfe\TNFeType\InfNFeAType\PagAType;

/**
 * Class representing DetPagAType
 */
class DetPagAType
{
     ...
     * Grupo de Cartões
     *
     * @property \Evino\Gallywix\DataTransfer\Nfe\TNFeType\InfNFeAType\PagAType\DetPagAType\CardAType
     * $card
     */
    private $card = null;
     ...
     * Grupo de Cartões
     *
     * @return \Evino\Gallywix\DataTransfer\Nfe\TNFeType\InfNFeAType\PagAType\DetPagAType\CardAType
     */
     ...
     * Grupo de Cartões
     *
     * @param \Evino\Gallywix\DataTransfer\Nfe\TNFeType\InfNFeAType\PagAType\DetPagAType\CardAType
     * $card
     * @return self
     */
    public function setCard(\Evino\Gallywix\DataTransfer\Nfe\TNFeType\InfNFeAType\PagAType\DetPagAType\CardAType $card)
    {
        $this->card = $card;
        return $this;
    }
