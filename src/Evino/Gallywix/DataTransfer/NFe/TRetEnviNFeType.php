...
class TRetEnviNFeType
{
     ...
     *
     * @property \Evino\Gallywix\DataTransfer\Nfe\TRetEnviNFeType\InfRecAType $infRec
     */
    private $infRec = null;
     ...
     * Dados do Recibo do Lote
     *
     * @return \Evino\Gallywix\DataTransfer\Nfe\TRetEnviNFeType\InfRecAType
     */
     ...
     * Dados do Recibo do Lote
     *
     * @param \Evino\Gallywix\DataTransfer\Nfe\TRetEnviNFeType\InfRecAType $infRec
     * @return self
     */
    public function setInfRec(\Evino\Gallywix\DataTransfer\Nfe\TRetEnviNFeType\InfRecAType $infRec)
    {
        $this->infRec = $infRec;
        return $this;
    }
